...
ViewModel::ViewModel() : Module("ViewModel", "Custom item view model", Category::RENDER) {
    ...
    // 添加动画速度控制
    registerSetting(new SliderSetting<float>("Swing Speed", "Swing animation speed", &swingSpeed, swingSpeed, 0.1f, 1.0f));
    registerSetting(new SliderSetting<float>("Eat Speed", "Eating animation speed", &eatSpeed, eatSpeed, 0.1f, 1.0f));
    
    registerSetting(new SliderSetting<float>("Translate X", "NULL", &mhTrans.x, mhTrans.x, -2.f, 2.f));
    registerSetting(new SliderSetting<float>("Translate Y", "NULL", &mhTrans.y, mhTrans.y, -2.f, 2.f));
    registerSetting(new SliderSetting<float>("Translate Z", "NULL", &mhTrans.z, mhTrans.z, -2.f, 2.f));
    ...
    registerSetting(new SliderSetting<float>("Rotation X", "NULL", &mhRot.x, mhRot.x, -180.f, 180.f));
    registerSetting(new SliderSetting<float>("Rotation Y", "NULL", &mhRot.y, mhRot.y, -180.f, 180.f));
    registerSetting(new SliderSetting<float>("Rotation Z", "NULL", &mhRot.z, mhRot.z, -180.f, 180.f));
}
