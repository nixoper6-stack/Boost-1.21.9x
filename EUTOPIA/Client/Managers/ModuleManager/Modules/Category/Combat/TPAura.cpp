...
TPAura::TPAura()
    : Module("TPAura", "Teleports and attacks entities using KillAura base", Category::COMBAT) {
    ...
    registerSetting(new SliderSetting<int>("MinCPS", "Min CPS", &minCPS, 5, 0, 20));
    registerSetting(new SliderSetting<int>("MaxCPS", "Max CPS", &maxCPS, 10, 0, 20));
