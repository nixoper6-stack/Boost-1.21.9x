...
class PlayerAuthInputPacket : public Packet {
   ...
   Vec3<float> mCameraOrientation;
    ...
    void removeMovingInput() {
        mInputData &=
            ~(AuthInputAction::UP | AuthInputAction::DOWN | AuthInputAction::LEFT |
              AuthInputAction::RIGHT | AuthInputAction::UP_LEFT | AuthInputAction::UP_RIGHT);
    ...
    PlayerAuthInputPacket& operator=(const PlayerAuthInputPacket& other) {
        ...
        /*mItemUseTransaction =
        std::make_unique<PackedItemUseLegacyInventoryTransaction>(*other.mItemUseTransaction);
...
/*static_assert(offsetof(PlayerAuthInputPacket, mNewInteractionModel) == 0x90,
"PlayerAuthInputPacket: mNewInteractionModel offset"); static_assert(offsetof(PlayerAuthInputPacket,
mClientTick) == 0x98, "PlayerAuthInputPacket: mClientTick offset");*/