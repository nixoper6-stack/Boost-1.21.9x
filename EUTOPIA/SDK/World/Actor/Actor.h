...
public:
    ...
    void teleport(const Vec3<float>& pos);
   ...
   public:
    ...
    void teleportTo(const Vec3<float>& pos, bool shouldStopRiding, int a, int b, bool keepVelocity) {
        MemoryUtil::callVirtualFunc<void, const Vec3<float>&, int, int, bool>(21, this, pos, shouldStopRiding, a, b ,keepVelocity);
	}
